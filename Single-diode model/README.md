...
<p align="center">
<img width="400" height="300" alt="Single-diode Model" src="https://github.com/user-attachments/assets/ff644b4b-ee3f-4fcb-b321-beda2e6005d1" />
</p>
...
- **alpha** — temperature coefficient of the short-circuit current [%/°C or %/K]
- **beta** — temperature coefficient of the open-circuit voltage [%/°C or %/K]  
- **T** — operating temperature [K]  
- **S** — operating irradiance [W/m²]  

This folder also contains three auxiliary scripts (implemented in both MATLAB and Python) for those interested in evaluating the results of the nonlinear system of equations and/or plotting the I–V curve :
...
**To use the emulator**, start by manually entering the previously mentioned datasheet parameters into `main.cpp` before uploading the firmware to the SPIN board. For detailed, step-by-step instructions, refer to the [Tutorial](https://github.com/GCBrito/PV-emulator/blob/main/Tutorial.md).
