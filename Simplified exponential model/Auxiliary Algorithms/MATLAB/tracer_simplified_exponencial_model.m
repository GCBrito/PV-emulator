...
Vmp = 34; % Maximum Power Voltage (V)
Imp = 4.4;  % Maximum Power Current (A)
Voc = 43.4; % Open-Circuit Voltage (V)
Isc = 4.8;  % Short-Circuit Current (A)
...
legend_labels = {'Simplified exp. model I-V curve'};
